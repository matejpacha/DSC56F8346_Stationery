...
Here we are manually accessing and creating virtual tables, this is not exactly standard C++
and needs to be done before including any headers.

*/

#define ABI_CONST_MASK		0x1		/* abi::__pbase_type_info::__const_mask */
...
#define FUNDAMENTAL_TYPEINFO_NAME	ABI_NS_NAME(23__fundamental_type_info)
	...
	const unsigned char CLASS_TYPEINFO_NAME[];
	const unsigned char SI_CLASS_TYPEINFO_NAME[];
	const unsigned char VMI_CLASS_TYPEINFO_NAME[];
	const unsigned char FUNDAMENTAL_TYPEINFO_NAME[];
	const unsigned char POINTER_TYPEINFO_NAME[];
...
#define POINTER_CONST_TYPE_INIT(mangledtypename) 					\
	...
	extern const pointerPOD _ZTIPK ## mangledtypename = { POINTER_TYPEINFO_NAME+sizeof(void*)*2, _ZTSPK ## mangledtypename, ABI_CONST_MASK, &_ZTI ## mangledtypename }
...
namespace {
	...
	/****************************************************************/
	inline bool ClassRTTIVTablePointerCompare(const void *vtbl, const void *tvtbl)
	{
