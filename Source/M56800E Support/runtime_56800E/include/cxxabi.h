...
extern "C" void * __cxa_vec_new (
            ...
            void (*constructor) ( unsigned int *thisp ),
            void (*destructor) ( unsigned int *thisp ) );
...
extern "C" void __cxa_vec_cctor (
            ...
            _CXXABI_SIZE_T element_count,
            _CXXABI_SIZE_T element_size,
            void (*constructor) (unsigned int *, void *),
...
extern "C" _MSL_IMP_EXP_RUNTIME int  __cxa_guard_acquire ( long long *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_release ( long long *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_abort ( long long *guard_object ) _MSL_WEAK;
#elif __IA64_CPP_ABI_ARM__ || __m56800E__
extern "C" _MSL_IMP_EXP_RUNTIME int  __cxa_guard_acquire ( int *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_release ( int *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_abort ( int *guard_object ) _MSL_WEAK;
#else
extern "C" _MSL_IMP_EXP_RUNTIME int  __cxa_guard_acquire ( unsigned char *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_release ( unsigned char *guard_object ) _MSL_WEAK;
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_guard_abort ( unsigned char *guard_object ) _MSL_WEAK;
#endif

//	cxxabi_pure.cpp
extern "C" _MSL_IMP_EXP_RUNTIME void __cxa_pure_virtual ( void ) _MSL_WEAK _MSL_NORETURN;
